...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
pin pinS[] = { { S1_GPIO_Port, S1_Pin }, { S2_GPIO_Port, S2_Pin }, {
S3_GPIO_Port, S3_Pin }, { S6_GPIO_Port, S6_Pin }, { S7_GPIO_Port, S7_Pin }, {
S5_GPIO_Port, S5_Pin }, { S8_GPIO_Port,
S8_Pin } };
int Sensors[] = { 0, 0, 0, 0 };
int inicio = 0;
uint32_t adc_buf[ADC_BUF_LEN];
uint32_t CNY70_1[ADC_BUF_LEN / 4];
uint32_t CNY70_2[ADC_BUF_LEN / 4];
uint32_t CNY70_3[ADC_BUF_LEN / 4];
uint32_t CNY70_4[ADC_BUF_LEN / 4];
int angulo;
