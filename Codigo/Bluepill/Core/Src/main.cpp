...
#define SHARP_D GPIO_PIN_1
#define SHARP_C GPIO_PIN_2
#define SHARP_I GPIO_PIN_3

#define CNY70 GPIO_PIN_0
...
struct Node Map[alto][ancho];

//visual map creation
struct Position visual;
struct Node VisualMap[ALTO][ANCHO];
